var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="4@md 12@sm offset-5@md" src="handwash.gif" alt="How to wash your hands." class="svelte-1wsp3u5"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	progressbar = new ProgressBar({
    			props: {
    				progress: (totalSeconds - /*secondsLeft*/ ctx[0]) / totalSeconds * 100
    			}
    		});
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button, "click", /*countdown*/ ctx[2]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*secondsLeft*/ 1) progressbar_changes.progress = (totalSeconds - /*secondsLeft*/ ctx[0]) / totalSeconds * 100;
    ...
    function create_fragment$3(ctx) {
    	...
    	timer.$on("end", function () {
    		if (is_function(/*audio*/ ctx[0].play())) /*audio*/ ctx[0].play().apply(this, arguments);
    	});
